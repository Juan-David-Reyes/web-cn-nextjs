...
export default function NosotrosPage() {
  return (
    <main className="min-h-screen flex flex-col bg-zinc-50 text-zinc-900 selection:bg-[#3dbf15]/30 overflow-hidden relative z-10 w-full">
      {/* Background Effects */}
      ...
      <div className="w-full relative h-[480px] bg-zinc-200 [clip-path:inset(0)]">
      ...
      {/* Hero Content */}
      <section className="w-full bg-[#FFFFFF] rounded-t-[48px] -mt-12 relative z-10 pt-12 pb-16 lg:pb-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6 flex flex-col items-center text-center w-full max-w-[1200px] mx-auto">
          <span className="text-[14px] uppercase tracking-[4px] leading-[160%] inline-block font-normal text-[#334155] ">
            SOBRE NOSOTROS
          </span>

          <h1 className="font-extrabold text-[#0f172a] leading-tight text-balance">
          ...
          <p className="text-lg md:text-xl text-zinc-600 leading-relaxed max-w-3xl mt-2 mx-auto">
